...
function TestimonialCard({ img, name, username, body, role }: (typeof testimonials)[number]) {
  return (
    <Card className="w-[300px] shrink-0 border-border/50 bg-card/80 backdrop-blur-sm hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
...
export default function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="section-spacing overflow-hidden relative">
